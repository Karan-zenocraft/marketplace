    ...
    <body>
            ...
            <div class="navbar-inner">
                <div class="container-fluid logo-container">
                    ...
                    <a class="brand logo" href="<?=\Yii::$app->urlManager->createUrl(['site/index']);?>">
                        <?php //Html::img(Yii::getAlias('@web') . '/img/Chiefs_rs_logo.png', ['width' => "33px", 'height' => "33px"])?>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <!--/span-->
                <div class="span9 rightsidebar" id="content">
                    <div class="row-fluid">
...
Breadcrumbs::widget([
    ...
    'homeLink' => ['label' => 'Dashboard', 'template' => '<li><i class="fa fa-home"></i>{link}</li> <span class="divider">/</span> ', 'url' => Yii::$app->request->baseUrl . '/site/index'],
])
?>
            ...
            <footer class="footer">
                <div class="container">
                    <div class="row">
                    <div class="col-md-12 ">
                    <p class="text-center ">&copy; <?=Yii::getAlias('@site_footer') . " " . date('Y');?></p>
                    </div>
                </div>
                </div>
            </footer>
